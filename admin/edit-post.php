...
$query=mysqli_query($con,"update tblposts set PostTitle='$posttitle',CategoryId='$catid',SubCategoryId='$subcatid',PostDetails='$postdetails',ExpiryDate='$expirydate',PostUrl='$url',Is_Active='$status' where id='$postid'");
if($query)
{
$msg="Post updated ";
}
...
<input type="date"  id="date" class="form-control hasDatepicker" name="date" required><?php echo htmlentities($row['ExpiryDate']);?></input>
</div>
</div>
</div>
...
<button type="submit" href="manage-posts.php" name="update" class="btn btn-success waves-effect waves-light">Update </button>
