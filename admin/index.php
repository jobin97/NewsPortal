                        ...
                        <div class="wrapper-page">
                            ...
                            <div class="m-t-40 account-pages">
                                <div class="text-center account-logo-box">
                                    <h2>
                                        <a href="admin/index.html" class="text-success">
                                            Admin Login
                                        </a>
                                    </h2>
                                ...
                                <div class="account-content">
                                    ...
                                    <!-- <a href="user.php" class="btn w-md btn-bordered btn-success waves-effect waves-light" type="submit" name="login">User Login</a> -->
